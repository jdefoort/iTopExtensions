<?php
	...
	$res = $i->post([
		"operation" => "core/get", 
		"class" => "Bike",
		"key" => "SELECT Bike WHERE id =".$_REQUEST["id"],
		"output_fields" => "name, organization_name, brand_name, model_name, chassis_number, documents_list"
	]);
	...
	$item = $res["objects"]["Bike::".$_REQUEST["id"]]["fields"];
...
//	print_r($res["objects"]["Bike::".$_REQUEST["id"]]["fields"]["bikepicture"]);

	// $pic = $res["objects"]["Bike::".$_REQUEST["id"]]["fields"]["bikeepicture"];
